...
<!-- Mirrored from www.iitg.ernet.in/civil/site/?page_id=65 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Feb 2018 04:24:18 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php

	include("includes/homepage/head.php");
?>
<body class="page-template page-template-page-templates page-template-inner-page page-template-page-templatesinner-page-php page page-id-65">
...
<div class="row">
           <!--  <div class="medium-12 columns">
    <p class="style13"><a href="http://www.iitg.ernet.in/civil/Environmental Laboratory/index.htm" target="_blank" rel="noopener noreferrer">Environmental Engineering Division</a></p>
<p class="style13"><a href="http://iitg.ernet.in/civil/geotech_lab.php" target="_blank" rel="noopener noreferrer">Geotechnical Engineering Division</a></p>
<p class="style13"><a href="http://iitg.ernet.in/civil/infrastructure_lab.php" target="_blank" rel="noopener noreferrer">Infrastructure Engineering and Management Division</a></p>
<p class="style13"><a href="http://www.iitg.ernet.in/civil/Structural Labaratory/index.htm" target="_blank" rel="noopener noreferrer">Structural Engineering Division</a></p>
<p class="style13"><a href="http://iitg.ernet.in/civil/transport_lab.php" target="_blank" rel="noopener noreferrer">Transportation Systems Engineering Division</a></p>
<p class="style13"><a href="http://www.iitg.ernet.in/civil/Water Resources Engineering/Water Resources Engineering/Home.php" target="_blank" rel="noopener noreferrer">Water Resources Engineering and Management Division</a></p>
<p class="style13"><a href="http://www.iitg.ernet.in/civil/Earth_Sciences_Lab/index.php" target="_blank" rel="noopener noreferrer">Earth System Science and Engineering Division</a></p>
<p class="style13"><a href="http://iitg.ernet.in/civil/survey_lab.php" target="_blank" rel="noopener noreferrer">Survey Laboratory</a></p>
<p class="style13"><a href="http://iitg.ernet.in/civil/computational_lab.php" target="_blank" rel="noopener noreferrer">Computational Laboratory</a></p>
</div>
</div> -->
<div style="padding-right: 50px; padding-left: 50px;">
	<?php 
	$query=mysqli_query($mysqli,"SELECT * FROM sub_pages WHERE uid=42");
...
<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-65 current_page_item menu-item-113"><a href="index85da.php?page_id=65">Laboratories/Divisions</a></li>
