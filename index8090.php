...
<!-- Mirrored from www.iitg.ernet.in/civil/site/?page_id=115 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Feb 2018 04:24:24 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php

	include("includes/homepage/head.php");
?>
<body class="page-template page-template-page-templates page-template-inner-page page-template-page-templatesinner-page-php page page-id-115">
...
<section class="all-pages">
	...
	<?php
$pname="Electrical Engineering - BoS MoM";
...
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-117"><a href="#">Research</a>
<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-115 current_page_item menu-item-120"><a href="index8090.php?page_id=115">Sponsored Projects</a></li>
